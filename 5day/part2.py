    ...
    for i in range(len(lines)):
        ...
        if first_point[0] == second_point[0] and first_point[1] is not second_point[1]:
            ...
            for j in range(difference + 1):
                ...
                #Add points within line
                if first_point[1] > second_point[1]:
                    changing_position = second_point[1] + j
                else:
                    changing_position = first_point[1] + j

                #Add to dict
                if f'x{first_point[0]}y{changing_position}' not in lines_dict:
                    lines_dict[f'x{first_point[0]}y{changing_position}'] = 1
                else:
                    lines_dict[f'x{first_point[0]}y{changing_position}'] += 1
            ...
            for j in range(difference + 1):
                ...
                if first_point[0] > second_point[0]:
                    ...
                    changing_position = first_point[0] + j

                if f'x{changing_position}y{first_point[1]}' not in lines_dict:
                    lines_dict[f'x{changing_position}y{first_point[1]}'] = 1
                else:
                    lines_dict[f'x{changing_position}y{first_point[1]}'] += 1
