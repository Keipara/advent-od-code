...
#       if it equals the chosen number, change it to a string
#
#   check if all numbers within row is a string
#           if so, save the board and...
            ...
            for k in range(len(board)):
                ...
                for l in range(len(row)):
                    if row[l] == current_number:
                        ...
                        if  rows_dict[f'board{j}row{k}'] == 5:
                            winner = sum(board[0] + board[1] + board[2] + board[3] + board[4])
                            print('Row Bingo:', winner, current_number, winner * current_number)
                        ...
                        if columns_dict[f'board{j}column{l}'] == 5:
                            winner = sum(board[0] + board[1] + board[2] + board[3] + board[4])
                            print('Column Bingo:', winner, current_number, winner * current_number)
                            return current_number
